...
;	va_pdn_regs:    .word 0xFFFD0000		
;	va_pxi_regs:    .word 0xFFFD2000
;	va_hook1_ret:   .word 0xFFF84DDC
	va_pdn_regs:    .word 0x0		
	va_pxi_regs:    .word 0x0
	va_hook1_ret:   .word 0x0
...
wait_arm11_loop:
	...
	pa_hijack_arm9_dst:  .word 0x1FFFFC00
	pa_arm11_code:       .word 0x1FFFFFFC
	pa_pxi_regs:         .word 0x10163000
	some_pxi_cmd:        .word 0x44846
	pa_firm_header:      .word 0x24000000
	pa_arm9_payload:     .word 0x23F00000
	pa_io_mem:           .word 0x10140000
